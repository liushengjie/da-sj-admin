      ...
      columns: [
        {
          ...
          render: (h, params) => {
            return h('div', [
              ...
              h('strong', params.row.TABLE_NAME)
            ])
          },
          sortable: true
        },
          ...
          render: (h, params) => {
            if (this.curLineIndex === 'remark' + params.index) {
              ...
              return h(
                ...
                params.row.remark || params.row.TABLE_COMMENT
              )
            }
          }
        },
          ...
          render: (h, params) => {
            return h('div', [
              ...
              h('icon', {
                ...
                on: {
                  click: e => {
                                    	this.variableParams = params.row.TABLE_NAME
                    this.openPreview(params.row.TABLE_NAME)
                  }
                }
              }),
              h('icon', {
                ...
                on: {
                  click: () => {
                    this.refreshCount(params.row.TABLE_NAME, params.index)
                  }
                }
              })
            ])
  ...
  methods: {
    ...
    refreshCount (tableName, index) {
      dbApi.findCountByTable({
        ...
        if (res.success) {
          this.tables_data[index].TABLE_ROWS = res.data
        }
      })
    },
